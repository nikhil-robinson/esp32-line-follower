...
esp_err_t Encoder::enable()
{
    return pcnt_unit_enable(this->pcnt_unit);
}

esp_err_t Encoder::disable()
{
    return pcnt_unit_disable(this->pcnt_unit);
}
...
esp_err_t Encoder::get_count(int *count)
{
...
{
    return pcnt_unit_add_watch_point(this->pcnt_uint, watch_point);

}

esp_err_t Encoder::remove_watch_point(int watch_point)
{
    return pcnt_unit_remove_watch_point(this->pcnt_uint, watch_point);
